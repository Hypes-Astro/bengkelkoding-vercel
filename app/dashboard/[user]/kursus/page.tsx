...
import { CourseResponse } from "@/app/interface/dashboard/admin/Courses";
...
const DashboardKursus = () => {
  ...
  const [listCourses, setListCourses] = useState<CourseResponse>();
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (role_user && (role_user === "superadmin" || role_user === "admin")) {
        response = await getAdminListCourses(
          searchTerm,
          currentPage,
          itemsPerPage
        );
