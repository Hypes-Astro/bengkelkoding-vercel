...
// List Courses
export const getAdminListCourses = async (
  search?: string,
  page?: number,
  limit?: number
): Promise<AxiosResponse> =>
  createRequest(
    `/api/v1/admin/courses?search=${search}&page=${page}&limit=${limit}`
  );
...
export const putAdminSortSectionCourses = async (
  ...
  createPutRequest(`/api/v1/admin/courses/${course_id}/sections`, {
    sections,
  });
